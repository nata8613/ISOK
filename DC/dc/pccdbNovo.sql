...
CREATE TABLE `merchant_license` (
  ...
  `merchant_pass` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `transactions` (
  ...
  `acquirer_order_id` bigint(20) DEFAULT NULL,
  `acquirer_order_timestamp` date DEFAULT NULL,
  `amount` bigint(20) NOT NULL,
  `merchant_order_id` bigint(20) NOT NULL,
  `merchant_order_timestamp` date NOT NULL,
...
-- Dump completed on 2018-02-02 12:54:10
